...
func Test_E2E_Response_Exec_PrintingEnv(t *testing.T) {
	RunTestWithEnv(
		...
		LineEquals(4, `MOCK_REQUEST_HEADER_HEADER_ONE=Header value one`),
		LineEquals(5, `MOCK_REQUEST_HEADER_HEADER_TWO=Header value two`),
		LineRegexMatches(6, `MOCK_REQUEST_HEADERS=.*`),
